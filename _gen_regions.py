...
provinces = [
    ...
    { "name":"台湾省", "cities":["台北市","高雄市","台中市","台南市","新北市","桃园市","基隆市","新竹市","嘉义市","新竹县","苗栗县","彰化县","南投县","云林县","嘉义县","屏东县","宜兰县","花莲县","台东县","澎湖县"] },
    { "name":"香港特别行政区", "cities":["香港特别行政区"] },
    { "name":"澳门特别行政区", "cities":["澳门特别行政区"] }
]
regions = { "华北":[0,1,2,3,4], "东北":[5,6,7], "华东":[8,9,10,11,12,13,14], "华中":[15,16,17], "华南":[18,19,20], "西南":[21,22,23,24,25], "西北":[26,27,28,29,30], "港澳台":[31,32,33] }
data = json.dumps({"provinces":provinces,"regions":regions}, ensure_ascii=False)
open('_regions.json','w',encoding='utf-8').write(data)
print('OK')
