...
Page({
  data: {
    ...
    showGoodsSales: true,
    showGoodsStock: true,
    showGoodsOriginalPrice: true,
    showGoodsPromotion: true,
    showGoodsDetail: true,
    showGoodsAttr: true,
    showGoodsComment: true,
    goodsDetailText: '商品详情',
    goodsAttrText: '商品属性',
    goodsCommentText: '商品评价',
    cartButton: true,
    buyButton: true,
    themeColor: '#FF6B35',
  },
  ...
  onShow() {
    settings.fetchSettings(true).then((s) => {
      this.setData({
        showGoodsSales: !!s.show_goods_sales,
        showGoodsStock: !!s.show_stock,
        showGoodsOriginalPrice: !!s.show_original_price,
        showGoodsPromotion: !!s.show_goods_promotion,
        showGoodsDetail: !!s.show_goods_detail,
        showGoodsAttr: !!s.show_goods_attr,
        showGoodsComment: !!s.show_goods_comment,
        goodsDetailText: s.text_goods_detail || '商品详情',
        goodsAttrText: s.text_goods_attr || '商品属性',
        goodsCommentText: s.text_goods_comment || '商品评价',
